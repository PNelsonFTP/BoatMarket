...
<p>Lake Holiday reference: the official rulebook dated December 2, 2025 permits hulled boats up to and including 21.0 ft by manufacturer US specifications, count molded platforms, limit motor power to the capacity rating, and prohibit wakesurfing and use of wake-enhancing devices. Verify the current rules and applicable boat category with the association before purchase. ${link("Official December 2025 Lake Holiday rulebook", LAKE_RULES_URL)}</p>
