...
import { BoatLocationReview } from "./boat-location-review";
type City = {
  key: string;
  city: string;
  state: string;
  ...
  return (
    <>
      <section className="settings-card">
        ...
        <p className="muted">
          Review city and ZIP centers used for approximate straight-line
          distance. Exact source coordinates are preserved. A reviewed center
          remains an estimate; use Actual boat location below for a
          seller-confirmed location.
        </p>
        <label>
          Find a city
          <input
        ...
        <div className="review-list">
          {cities
            ...
            .map((c) => (
              ...
              >
                {c.city}, {c.state}
                {c.zip ? ` ${c.zip}` : ""} · {c.ads} ads · {c.unknown} unlocated
      ...
      <BoatLocationReview connection={connection} onRefresh={onRefresh} />
    </>
  );
}
